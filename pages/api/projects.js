    ...
    res.status(200).json([
        {
            name: 'Accedo',
            img: '/logo-accedo.svg',
            description: `Accedo es la empresa en la que trabajo actualmente, 
            ...
            links: [
                {
                    type: 'page',
                    url: 'https://www.accedotechnologies.com/'
                }
            ],
            technology_stack: {
                description: 'Las Principales tecnologias que uso',
                technologies: [
        ...
        },
        {
            ...
            links: [
                {
                    type: 'page',
                    url: 'https://osmisog.github.io/pokemon-react/',
                    title: 'PokePage React'
                },
                {
                    type: 'github',
                    url: 'https://github.com/OsmiSOG/pokemon-react',
                    title: 'PokePage GitHub React'
                },
                {
                    type: 'page',
                    url: 'https://pokemon-api-d2eb5.web.app/',
                    title: 'PokePage Vue'
                },
                {
                    type: 'github',
                    url: 'https://github.com/OsmiSOG/pokemon-project',
                    title: 'PokePage GitHub Vue'
                }
            ],
            technology_stack: {
                description: 'Tecnologias implementadas',
                technologies: [
                    'React', 'Vue', 'Vuex', 'firebase', 'api pokemon'
                ]
            }
        },
        {
            name: 'Process Pluss',
            img: '/logo-process-plus.png',
            description: `Este fue en la primer empresa y de igual modo proyecto en el que trabaje,
            ...
            links: [
                {
                    type: 'page',
                    url: 'http://process.grupotesta.com.co:8989/Pruebas/public/Ingreso'
                }
            ],
            technology_stack: {
                description: 'Las Principales tecnologias que uso',
        ...
        {
            name: 'Valorator Uniminuto',
            img: 'https://rebrand.ly/valoratorUniminuto',
            description: `Este fue el proyecto que trabaje dentro del semillero universitario,
            ...
            links: [
                {
                    type: 'page',
                    url: 'https://rebrand.ly/valoratorUniminuto'
                }
            ],
            technology_stack: {
                description: 'Tecnologias implementadas',
        ...
        },
        {
            name: 'puzzle 15',
            img: '/puzzle.png',
            description: `Este fue uno de mis proyectos universitarios, 
            ...
            links: [
                {
                    type: 'page',
                    url: 'https://osmisog.github.io/Puzzle15/'
                }
            ],
            technology_stack: {
                description: 'Tecnologias implementadas',
        ...
        },
        {
            ...
            img: '/others.png',
            description: `Dentro de mi trayectoria, he realizado una gran variedad de proyectos, 
            ...
            links: [
                {
                    type: 'github',
                    url: 'https://github.com/OsmiSOG'
                },
                {
                    type: 'github',
                    url: 'https://github.com/osmiOTALORAGUERRERO'
                }
            ],
            technology_stack: {
                description: 'Tecnologias usadas',
                technologies: [
